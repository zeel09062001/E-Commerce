...
<body>
    ...
    <section class="orders-container">
        <form id="orderForm" method="post" action="shopping.php">
            ...
            <a id="cancle" href="index.php">
                <CEnter>CANCLE</CEnter>
            </a>
        </form>
    </section>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#popupContent").html(
                            ...
                            "<br>Quantity:" + data.quntity +
                            "<br>Price:" + data.price +
                            "<br>Tax Amount: " + data.tax +
                            "<br>Total Amount: " + data.totalammount +
                            "<br>"
                        );
